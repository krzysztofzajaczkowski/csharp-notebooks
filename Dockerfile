FROM mcr.microsoft.com/dotnet/sdk:5.0 as parsing
...
RUN curl https://gist.githubusercontent.com/krzysztofzajaczkowski/4864d536a90749f02c3acd0efbe6a1e4/raw/df921dc8b91601a3530a98cf29d78e0ad11dbef8/converter.csx > parser.csx

# Parse notebooks
RUN chmod +x parser.csx 
RUN dotnet script parser.csx -- dib-notebooks/

# Copy parsed notebooks
RUN cp -R converted/dib-notebooks /Notebooks/
...
# Copy notebooks
COPY --from=parsing /Notebooks ${HOME}/Notebooks/
